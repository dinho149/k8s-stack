...
# `make teleport-up` already enrols admin; run this to rotate the credentials or after they were lost.
...
ui::info "log in:  make teleport-login            (tsh, no prompts)"
ui::info "         make teleport-web-login        (browser: prints user / password / TOTP)"
